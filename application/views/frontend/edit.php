    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="card">                      
                    <div class="card-body">
                        <form action="<?php echo base_url('student/update/'.$studentes->id);?>" method="POST">
                        <div class="container">
                            <div class="row">
                            <h5 class="pt-3">Modifier</h5>
                                <div class="col-12 col-lg-6">
                                    <label for="">Nom</label>
                                    <input type="text" name="first_name" value="<?=$studentes->first_name?>" class="form-control inputbox">
                                    <small class="formvali"><?php echo form_error('first_name');?></small>

                                </div>
                                <div class="col-12 col-lg-6">
                                    <label for="">Pren Nom</label>
                                    <input type="text" name="last_name"  value="<?=$studentes->last_name?>" class="form-control inputbox">
                                    <small class="formvali"><?php echo form_error('last_name');?></small>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <Label>Telephone</Label>
                                    <input type="number" name="phone_stu" value="<?=$studentes->phone_stu?>" class="form-control inputbox">
                                    <small class="formvali"><?php echo form_error('phone_stu');?></small>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <Label>Email</Label>
                                    <input type="text" name="email_stud" value="<?=$studentes->email_stud?>" class="form-control inputbox">
                                    <small class="formvali"><?php echo form_error('email_stud');?></small>
                                </div>
                                <div class="col-12 col-lg-6 py-4" align="left">
                                    <button class="buttion_add">&nbsp;&nbsp; Modifier &nbsp;&nbsp;</button>&nbsp;
                                </div>
